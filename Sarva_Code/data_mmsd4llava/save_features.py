...
model = CLIPModel.from_pretrained("code/LLM_MSD/clip-vit-large-patch14-336").to(device)
processor = CLIPProcessor.from_pretrained("code/LLM_MSD/clip-vit-large-patch14-336")
image_folder = "code/LLM_MSD/data/dataset_image"

data_folder = "code/LLM_MSD/data/mmsd2.0_dataset" # MMSD2.0
max_len = 77
