...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-path", type=str, default="code/LLM_MSD/opt-350m")
    parser.add_argument("--model-base", type=str, default=None)
    parser.add_argument("--image-folder", type=str, default="code/LLM_MSD/data/dataset_image")
    parser.add_argument("--data-file", type=str, default="code/LLM_MSD/data_mmsd4llava/test_mmsd2.json")
